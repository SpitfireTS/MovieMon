...
namespace MovieMon.Api.Controllers
{
    ...
    public class MoviesController : ApiController
    {
        ...
        private HttpResponseMessage<IEnumerable<Movie>> SafeInvoke(Func<HttpResponseMessage<IEnumerable<Movie>>> searchMethod)
        {
            try
            {
                return searchMethod();
            ...
            catch (Exception e)
            {
                ...
                return new HttpResponseMessage<IEnumerable<Movie>>(new List<Movie>(), HttpStatusCode.OK);
            }
        }
    }
}
